...
public final class Matcher {
     ...
     *
     * @param fileName The file name to match, as a String. 
     *        It must be just a file name, without a path.
     * @param patterns The pattern array to match against. 
     *
     * @return <code>true</code> if any pattern in the set matches against the
     *         file name, or <code>false</code> otherwise.
     */
    public static boolean matchName(String fileName, String... patterns) {
        if (null == fileName || null == patterns) {
            throw new NullPointerException("fileName and patterns Must not be null!");
        }
